...
#define HOSTNAME "papa_room"

String hostname_string = String(HOSTNAME) + String("-") + String(ESP.getChipId(), HEX);
const char* hostname = hostname_string.c_str();

const char* light_command_channel = "papa_room/light/switch";
const char* light_status_channel = "papa_room/light/status";
const char* temp_channel = "papa_room/climate/temp";
const char* humid_channel = "papa_room/climate/humid";

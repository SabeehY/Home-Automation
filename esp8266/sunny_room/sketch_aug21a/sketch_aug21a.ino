...
#define LED 2
#define RELAY 5
#define Subscribe_Channel "sunny_room"
#define Publish_Channel "status/sunny_room"
...
void onMqttMessage(char* topic, char* payload, AsyncMqttClientMessageProperties properties, size_t len, size_t index, size_t total) {
  ...
  if (message == '1' || message == 'ON') {
    ...
    mqttClient.publish(Publish_Channel, 0, false, "ON");
  
  } else if (message == '0' || message == 'OFF') {
    lightOff();
    Serial.print("Turning OFF");
    mqttClient.publish(Publish_Channel, 0, false, "OFF");
